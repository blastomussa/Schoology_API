...
def post_request(api_call,json):
    method = "POST"
    ...
    # make request and read data
    d = requests.post(signed_url,json=json)
    data = d.text
...
def put_request(api_call,json):
    ...
    # make request and read data
    d = requests.put(signed_url,json=json)
    data = d.text
...
# test calls
def test():
    call = "https://api.schoology.com/v1/users?limit=1"

    data = get_request(call)
    print(data)
